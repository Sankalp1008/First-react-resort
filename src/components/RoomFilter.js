...
export default function RoomFilter({rooms}) {
    ...
    const {handleChange,price,maxPrice,minPrice,maxSize,minSize,breakfast,pets,type,capacity}=context;
    //get unique types
    ...
    return (
        <section className="filter-container">
            ...
            <form className="filter-form">
                ...
                <select name="type" value={type} id="type"
            ...
            {/* guest */}
                <div className="form-group">
                    ...
                    <select name="capacity" value={capacity} id="capacity"
                        className="form-control" onChange={handleChange}>
                        {people}
                    </select>
